...
export class UploadComponent extends HTMLElement {
     ...
     */
    async processRegularResponse(response) {
    ...
    handleUploadComplete(result) {
        setTimeout(() => {
            this.showSuccess(`Successfully imported ${result.successful_imports || 0} transactions ` +
