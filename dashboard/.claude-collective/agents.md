...
- **@testing-implementation-agent** - GPT-5-Codex powered testing with advanced code analysis and intelligent test generation
...
- **@functional-testing-agent** - GPT-5-Codex powered real browser testing with Playwright validation and intelligent test execution
