...
- **Agent Documentation**: Maintain AGENT-INTERACTION-DIAGRAM.md in .gemini/docs/
...
1. **Ecosystem Analysis**: Scan .gemini/agents/ for current capabilities and changes
2. **Documentation Validation**: Check .gemini/docs/ for accuracy and syntax errors
...
**ROUTE TO: @gemini-agent-name - [Specific reason]** OR **MAINTENANCE COMPLETE**
