...
- Route to @gemini-research-agent or @gemini-prd-research-agent first
...
**ROUTE TO: @gemini-agent-name - [Specific reason]** OR **WORKFLOW COMPLETE**
...
**My Coordination**:
1. Route to @gemini-research-agent for React + Node.js + auth best practices
2. Route to @gemini-infrastructure-implementation-agent for project setup  
3. Route to @gemini-feature-implementation-agent for API and auth logic
4. Route to @gemini-component-implementation-agent for React UI
5. Route to @gemini-testing-implementation-agent for integration tests
