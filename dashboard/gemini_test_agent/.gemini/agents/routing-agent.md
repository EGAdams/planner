...
- **Implementation Tasks** → `gemini-implementation-agent`, `gemini-component-agent`, `gemini-feature-agent`
- **Testing Requirements** → `gemini-testing-agent`, `gemini-tdd-validation-agent`
- **Quality Assurance** → `gemini-quality-agent`, `gemini-security-agent`
- **Research Needs** → `gemini-research-agent`, `gemini-metrics-agent`
- **Infrastructure** → `gemini-infrastructure-agent`, `gemini-devops-agent`
- **Project Management** → `gemini-project-manager-agent`, `gemini-task-orchestrator`
...
"Use @gemini-implementation-agent to create the login system"

# Multi-agent coordination
"Coordinate @gemini-testing-agent and @gemini-implementation-agent for TDD workflow"
```

## Configuration

The routing-agent behavior can be configured through `.gemini/settings.json`:
