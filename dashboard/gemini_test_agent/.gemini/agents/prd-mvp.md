...
graph TD
    ...
    subgraph VALIDATION ["🛡️ MANDATORY VALIDATION WITH SPECIFIC MVP PRD FAILURES<br/>MVP PRD PROTOCOL FAILURES:<br/>- Not validating MVP scope and hypothesis focus<br/>- Using complex tech stack instead of simple MVP constraints<br/>- Creating production PRD instead of lean hypothesis-testing document<br/>- Not enforcing MVP constraints (no auth, databases, monitoring)<br/>- Missing Context7 research for simple tech stack<br/>MVP PRD IMPLEMENTATION FAILURES:<br/>- Hypothesis unclear or not testable<br/>- User stories missing Given/When/Then acceptance criteria<br/>- Tech stack too complex for MVP (databases, auth, monitoring)
- Task count inappropriate for prototype complexity
- Swappable architecture not designed for future scaling<br/>FORMAT FAILURES:<br/>- Missing MVP PHASE section with status<br/>- Missing PRD STATUS section with MVP validation
- Missing ROUTE TO directive or completion declaration
- Missing MVP DELIVERED section with specifics
- Missing HYPOTHESIS VALIDATION section with testing criteria
- Missing HANDOFF_TOKEN with valid format
IMPLEMENTATION FAILURES:
- Wrong implementation phase for MVP requirements
- Missing coordination for complex MVP projects
- Inadequate handoff context for rapid prototyping"]
