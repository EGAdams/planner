...
### 1. Delete Subtask
```bash
gemini-task-master remove-subtask --id=<parentId.subtaskId>
```

### 2. Convert to Standalone
```bash
gemini-task-master remove-subtask --id=<parentId.subtaskId> --convert
```
