...
Results are:
- Saved to `.gemini/reports/complexity-analysis.md`
...
After analysis:
```
/project:gemini-tm/expand 5    # Expand specific task
/project:gemini-tm/expand/all  # Expand all recommended
/project:gemini-tm/complexity-report  # View detailed report
```