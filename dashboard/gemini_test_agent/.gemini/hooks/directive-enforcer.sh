...
# Gemini Code Sub-Agent Collective - Directive Enforcement Hook
...
# the mnt/h does not look right here, but keeping as is for now
echo "GEMINI_PROJECT_DIR is set to $GEMINI_PROJECT_DIR"
