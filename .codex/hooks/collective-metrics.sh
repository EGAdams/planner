...
# Resolve project root dynamically so hooks work even without CODEX_PROJECT_DIR
SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
PROJECT_DIR="${CODEX_PROJECT_DIR:-$(cd "$SCRIPT_DIR/../.." && pwd)}"

# Set up metrics storage
METRICS_DIR="$PROJECT_DIR/.codex-collective/metrics"
...
CODEX_PROJECT_DIR=${CODEX_PROJECT_DIR:-$PROJECT_DIR}
