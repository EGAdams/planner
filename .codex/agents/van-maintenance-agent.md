...
- **Agent Documentation**: Maintain AGENT-INTERACTION-DIAGRAM.md in .codex/docs/
...
1. **Ecosystem Analysis**: Scan .codex/agents/ for current capabilities and changes
2. **Documentation Validation**: Check .codex/docs/ for accuracy and syntax errors
