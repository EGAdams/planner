...
2. **FETCH TASK DETAILS**: Execute `mcp__task-master__get_task --id=<ID> --projectRoot=/home/adamsl/codex_tdd_orchestrator`
...
mcp__task-master__get_task --id=<PROVIDED_ID> --projectRoot=/home/adamsl/codex_tdd_orchestrator
