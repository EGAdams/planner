...
mcp__task-master__get_task --id=1 --projectRoot=/home/adamsl/codex_tdd_orchestrator

# Update task status to in-progress
mcp__task-master__set_task_status --id=1.X --status=in-progress --projectRoot=/home/adamsl/codex_tdd_orchestrator

# Update task with progress
mcp__task-master__update_task --id=1.X --prompt="Progress update" --projectRoot=/home/adamsl/codex_tdd_orchestrator

# Mark subtask complete
mcp__task-master__set_task_status --id=1.X --status=done --projectRoot=/home/adamsl/codex_tdd_orchestrator
```
