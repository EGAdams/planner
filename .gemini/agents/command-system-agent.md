...
```bash
# Get Task 5 details
mcp__task-master__get_task --id=5 --projectRoot=/mnt/h/Active/taskmaster-agent-gemini-code

# Update subtask status to in-progress
mcp__task-master__set_task_status --id=5.X --status=in-progress --projectRoot=/mnt/h/Active/taskmaster-agent-gemini-code

# Update task with progress
mcp__task-master__update_task --id=5.X --prompt="Command system development progress" --projectRoot=/mnt/h/Active/taskmaster-agent-gemini-code

# Mark subtask complete
mcp__task-master__set_task_status --id=5.X --status=done --projectRoot=/mnt/h/Active/taskmaster-agent-gemini-code
```
