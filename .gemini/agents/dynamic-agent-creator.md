...
mcp__task-master__get_task --id=7 --projectRoot=/mnt/h/Active/taskmaster-agent-gemini-code
mcp__task-master__set_task_status --id=7.X --status=in-progress --projectRoot=/mnt/h/Active/taskmaster-agent-gemini-code
```
...
5. **Integration**: Add agent to .gemini/agents/ directory
