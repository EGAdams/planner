...
```bash
# Get Task 6 details
mcp__task-master__get_task --id=6 --projectRoot=/mnt/h/Active/taskmaster-agent-gemini-code

# Update subtask status to in-progress
mcp__task-master__set_task_status --id=6.X --status=in-progress --projectRoot=/mnt/h/Active/taskmaster-agent-gemini-code

# Research context for metrics implementation
# Research metrics collection best practices using Gemini knowledge base (instant)

# Update task with progress
mcp__task-master__update_task --id=6.X --prompt="Metrics collection development progress" --projectRoot=/mnt/h/Active/taskmaster-agent-gemini-code

# Mark subtask complete
mcp__task-master__set_task_status --id=6.X --status=done --projectRoot=/mnt/h/Active/taskmaster-agent-gemini-code
```
