/**
 * ResearchDrivenAnalyzer - Autonomous complexity analysis using Gemini research cache
 *
 * This class replaces task-master delegation with research-informed decision making.
 * It analyzes tasks against cached Gemini documentation to make autonomous complexity scoring
 * and selective expansion decisions.
 */
class ResearchDrivenAnalyzer {
    constructor(projectRoot, cacheDirectory = '.gemini/docs/research/') {
        this.projectRoot = projectRoot;
        this.cacheDir = cacheDirectory;
        this.researchCache = {};
        this.complexityFactors = {
            // React patterns from Gemini
            ...
            // TypeScript complexity from Gemini
            ...
            // Build/tooling complexity from Gemini
            ...
            // Testing complexity from Gemini
            ...
            // Data/state complexity from Gemini
    ...
    buildResearchContext(detectedFactors, researchHints) {
        ...
        return {
            ...
            research_files: researchFiles.map(f => `.gemini/docs/research/${f}`),
    ...
    generateRecommendations(analyses) {
        ...
        if (lowResearchCoverage.length > 0) {
            recommendations.push({
                ...
                message: `${lowResearchCoverage.length} tasks could benefit from additional Gemini research.`,
