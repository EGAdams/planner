...
Guides you through setting up AI providers for Gemini Task Master.
...
Based on your needs:
- **For best results**: Gemini + Perplexity
- **Budget conscious**: GPT-3.5 + Perplexity
- **Maximum capability**: GPT-4 + Perplexity + Gemini fallback
