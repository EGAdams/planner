Learn about Gemini Task Master capabilities through interactive exploration.

Arguments: $ARGUMENTS

## Interactive Gemini Task Master Learning
...
1. /project:gemini-task-master:init <prd-file>
   → Creates tasks from requirements
   
2. /project:gemini-task-master:parse-prd <file>
   → Alternative task generation

Try: /project:gemini-task-master:init demo-prd.md
```
...
**By Scenario:**
- "I want to see what to work on" → `/project:gemini-task-master:next`
- "I need to break this down" → `/project:gemini-task-master:expand <id>`
- "Show me everything" → `/project:gemini-task-master:status`
- "Just do it for me" → `/project:gemini-workflows:auto-implement`

### 4. **Power User Patterns**

**Command Chaining:**
```
/project:gemini-task-master:next
/project:gemini-task-master:start <id>
/project:gemini-workflows:auto-implement
```

**Smart Filters:**
```
/project:gemini-task-master:list pending high
/project:gemini-task-master:list blocked
/project:gemini-task-master:list 1-5 tree
```

**Automation:**
```
/project:gemini-workflows:pipeline init → expand-all → sprint-plan
```
...
Type: /project:gemini-help <command-name>