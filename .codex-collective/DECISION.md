...
1. **CHECK CONTEXT FILE**: Read `.codex/handoff/NEXT_ACTION.json` if exists
...
**Handled by hooks (.codex/hooks/test-driven-handoff.sh):**
...
- **Normal conversation**: Standard Codex behavior + auto-delegation capability
