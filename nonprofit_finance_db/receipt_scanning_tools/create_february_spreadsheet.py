...
OUTPUT_FILE = OUTPUT_DIR / "february_2025_spreadsheet.csv"
...
def write_spreadsheet(rows: List[SpreadsheetRow]) -> Path:
    ...
    with OUTPUT_FILE.open("w", newline="", encoding="utf-8") as csv_file:
        ...
        writer.writerow(["February 2025 Financial Activity (MySQL Source)"])
        writer.writerow(
            [
...
def main() -> None:
    ...
    print(f"✓ February spreadsheet created: {spreadsheet_path}")
