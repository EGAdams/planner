...
AGENT_ID_FILE = WORKSPACE_DIR / "spreadsheet-agent_id.txt"
...
def get_or_create_agent(client: Letta, force_new: bool = False) -> Any:
    ...
    if AGENT_ID_FILE.exists() and not force_new:
        try:
            ...
            agent_id = None
            print( "*** Spreadsheet Agent not found! Exiting... ***" )
            exit(1)
...
def main(user_message: str, force_new_agent: bool = False):
    """Send a message to Spreadsheet Agent."""

    print("="*70)
    print("LETTA Spreadsheet Agent INTERACTION")
    print("="*70)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        # Interactive mode
        print("\n" + "="*70)
        print("INTERACTIVE MODE - Chat with Spreadsheet Agent")
        print("="*70)
